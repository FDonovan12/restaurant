...
public class ReservationController {
    ...
    public ModelAndView index(ModelAndView mav) {
        mav.setViewName("reservation/index");
        mav.addObject("reservations", reservationService.findAll());
        return mav;
    }

    @GetMapping(value = UrlRoute.URL_RESERVATION + "/{field}")
    public ModelAndView show(ModelAndView mav, @PathVariable String field) {
        ...
        mav.setViewName("reservation/show");
        mav.addObject("reservation", reservation);
        return mav;
    }

    @GetMapping(path = UrlRoute.URL_RESERVATION_NEW)
    ...
    @GetMapping(path = UrlRoute.URL_RESERVATION_EDIT + "/{id}")
    ...
    private ModelAndView getFormByDTO(ModelAndView mav, ReservationDTO dto, String uri, boolean isEdit) {
        mav.setViewName("reservation/form");
    ...
    private ModelAndView formHandle(BindingResult result, ModelAndView mav, ReservationDTO dto, Long id) {
        ...
        mav.setViewName("redirect:" + UrlRoute.URL_RESERVATION);
        return mav;
    }
